...
### Rule 17: Core Library (`pkg`) Standards

```
✅ MANDATORY: Follow SOLID, KISS, DRY principles
✅ MANDATORY: Use OOP features (Interfaces, Composition)
✅ MANDATORY: 100% Documentation coverage for exported symbols
✅ MANDATORY: >90% Test coverage
❌ FORBIDDEN: Business logic in `pkg` (keep it generic)
```

**Rationale:** `pkg` is the foundation. If it's weak or complex, everything built on it suffers.
